...
Describe general diagram of pop trend assessment and sources of uncertainty and/or complexity.

Given the diversity of factors influencing final assessment, rapid expansion of computation demands for even the simplest scenarios (sample sizes, monitoring frequency, etc.).

Creates demand for methods of approximating some of the detailed components to speed up computation (as well as perhaps other robustness gains? speed of development?).

Weighing the expected benefits (accuracy and speed of overall design assessment) stemming from more in depth development of better performing approximations against the time spent developing the approximation. What is an effective allocation of effort between developing approximations versus running simulations? 

Particularly interested in assessment methods constructible from initial analyses of pilot project data.
